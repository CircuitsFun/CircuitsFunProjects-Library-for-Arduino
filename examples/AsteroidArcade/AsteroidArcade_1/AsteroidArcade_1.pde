/*
* AsteroidArcade
* An improved version of the AsteroidAttack game from the Arduino CTC pack.
*/

import processing.serial.*;

float speedMonitor = 2;
...
float asteroidMaxSize=100; // Max size for random method
...
float life=1400; // The players life points
...
void newAsteroid() {
  ...
  asteroidArr.add(new Asteroid(asteroidXPos, random(2, asteroidSpeed), asteroidSize));
}
